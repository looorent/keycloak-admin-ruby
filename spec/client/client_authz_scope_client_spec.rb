...
RSpec.describe KeycloakAdmin::ClientAuthzScopeClient do
  ...
  describe "#create" do
    ...
    before(:each) do
      ...
      stub_token_client
      stub_request(:post, /.*/).to_return(body: '{"id":"c0779ce3-0900-4ea3-b1d6-b23e1f19c662","name":"GET","iconUri":"http://asdfasd1","displayName":"GET authz scope"}')
    end
  ...
  describe "#list" do
    ...
    before(:each) do
      @client_authz_scope = KeycloakAdmin.realm(realm_name).authz_scopes(client_id)
      stub_token_client
      stub_request(:get, /.*/).to_return(body: '[{"id":"c0779ce3-0900-4ea3-b1d6-b23e1f19c662","name":"GET","iconUri":"http://asdfasd1","displayName":"GET authz scope"},{"id":"d0779ce3-0900-4ea3-b1d6-b23e1f19c662","name":"POST","iconUri":"http://asdfasd2","displayName":"POST authz scope"}]')
    end
  ...
  describe '#get' do
    ...
    before(:each) do
      @client_authz_scope = KeycloakAdmin.realm(realm_name).authz_scopes(client_id)
      stub_token_client
      stub_request(:get, /.*/).to_return(body: '{"id":"c0779ce3-0900-4ea3-b1d6-b23e1f19c662","name":"GET","iconUri":"http://asdfasd1","displayName":"GET authz scope"}')
    end
